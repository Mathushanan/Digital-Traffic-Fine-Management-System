...
const RegisterPublic = () => {
  ...
  const [submissionLicenseNumber, setSubmissionLicenseNumber] = useState("");
    ...
    try {
      ...
      const response = await axios.post(
        registerPublicUserUrl,
        {
          ...
          licenseNumber: submissionLicenseNumber,
      ...
      if (response.status == 200) {
        setMessage(`Public user registered successfully!`);
        setMessageType("success");
        setShowDetails(false);
      } else {
        setMessage(`Failed to register the public user!`);
        setMessageType("error");
      }
    } catch (error) {
  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setSubmissionLicenseNumber(fetchedUser.licenseNumber);
    ...
    <>
      ...
      <div className="container d-flex justify-content-center align-items-center mt-2">
        <div className="p-4" style={{ maxWidth: "600px", width: "100%" }}>
          <h3 className="text-start mb-4">Register Public User</h3>
