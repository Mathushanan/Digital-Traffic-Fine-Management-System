...
const EditPublicModal = ({ show, onClose, publicUser, onSave }) => {
  ...
  useEffect(() => {
    if (publicUser) {
      ...
      setGender(publicUser.gender);
      setDateOfBirth(publicUser.dateOfBirth);
      setAddress(publicUser.address);
      setContactNumber(publicUser.contactNumber);
      setEmail(publicUser.email);
      setNicNumber(publicUser.nicNumber);
      setLicenseNumber(publicUser.licenseNumber);
    }
  }, [publicUser]);
  ...
  const handleSave = () => {
    ...
    onSave(updatedPublicUser);
    onClose();
    console.log(updatedPublicUser);
  };
