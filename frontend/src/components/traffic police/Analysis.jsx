...
const Analysis = () => {
  ...
  const fetchStatistics = async () => {
    try {
      ...
      if (response.status === 200) {
        ...
        console.log("statistics", fetchedStatistics);
  ...
  const fetchFines = async () => {
    try {
      const fetchFinesUrl = `${
        import.meta.env.VITE_API_BASE_URL
      }/get-all-fines-to-traffic-police`;
      const token = localStorage.getItem("authToken");
      const decodedToken = jwtDecode(token);
      console.log(decodedToken);
  ...
  // Pie chart data for Fine Status
  const fineStatusData = [
    { name: "Disputed", value: statistics.disputedFines, fill: "#ff8042" },
    { name: "Paid", value: statistics.paidFines, fill: "#82ca9d" },
    { name: "Pending", value: statistics.pendingFines, fill: "#8884d8" },
  ];

  // Pie chart data for Personnel Distribution
  const personnelData = [
    {
      name: "Traffic Police Officers",
      value: statistics.totalRegisteredTrafficPoliceOfficers,
      fill: "#d48265",
    },
    {
      name: "Public Users",
      value: statistics.totalRegisteredPublicUsers,
      fill: "#91c7ae",
    },
  ];
      ...
      <div className="container ">
        ...
        <div className="row mt-4 ">
          <div className="col-md-6 ">
            ...
            >
              <h5 className="text-center text-muted my-3">
                Most Frequent Violations Recorded By You
              </h5>
          ...
          <div className="col-md-6">
            ...
            >
              <h5 className="text-center text-muted my-3">
                Fine Status Overview Recorded By You
              </h5>
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                  <Pie
